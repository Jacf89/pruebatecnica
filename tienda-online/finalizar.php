...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top bg-danger">
      <div class="container bg-danger">
        <div class="navbar-header ">
          ...
          <a class="navbar-brand" href="index.php">NINTENDO STORE Store</a>
        </div>
    ...
    <div class="container" id="main">
                    ...
                    <fieldset>
                        <legend>Completar Datos</legend>
                            <form action="completar_pedido.php" method="post">
                                ...
                                <button type="submit" class="btn btn-primary btn-block" data-toggle="modal" hreft= "#popub">Enviar</button>
                            </form>
                    </fieldset>
                </div>
            </div>
      ...
      <div class="modal fade" id="popub1"></div>
